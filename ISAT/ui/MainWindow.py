# Form implementation generated from reading ui file 'ISAT/ui\MainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/icons/ISAT13_100.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.menuSAM_model = QtWidgets.QMenu(parent=self.menubar)
        ...
        self.info_dock = QtWidgets.QDockWidget(parent=MainWindow)
        self.info_dock.setMinimumSize(QtCore.QSize(85, 43))
        self.info_dock.setFeatures(QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetClosable | QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetFloatable | QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetMovable)
        ...
        self.annos_dock = QtWidgets.QDockWidget(parent=MainWindow)
        self.annos_dock.setMinimumSize(QtCore.QSize(85, 43))
        self.annos_dock.setFeatures(QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetClosable | QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetFloatable | QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetMovable)
        ...
        self.files_dock = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        self.categories_dock = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        MainWindow.addToolBar(QtCore.Qt.ToolBarArea.RightToolBarArea, self.toolBar_2)
        self.actionImages_dir = QtGui.QAction(parent=MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icon/icons/照片_pic.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icon/icons/放大_zoom-in.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionZoom_in.setIcon(icon2)
        self.actionZoom_in.setObjectName("actionZoom_in")
        self.actionZoom_out = QtGui.QAction(parent=MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icon/icons/缩小_zoom-out.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionZoom_out.setIcon(icon3)
        self.actionZoom_out.setObjectName("actionZoom_out")
        self.actionFit_window = QtGui.QAction(parent=MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icon/icons/全宽_fullwidth.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icon/icons/设置_setting-two.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionSetting.setIcon(icon5)
        self.actionSetting.setObjectName("actionSetting")
        self.actionExit = QtGui.QAction(parent=MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icon/icons/开关_power.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionExit.setIcon(icon6)
        self.actionExit.setObjectName("actionExit")
        self.actionLabel_dir = QtGui.QAction(parent=MainWindow)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon/icons/文件夹-开_folder-open.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionLabel_dir.setIcon(icon7)
        self.actionLabel_dir.setObjectName("actionLabel_dir")
        self.actionSave = QtGui.QAction(parent=MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon/icons/保存_save.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionSave.setIcon(icon8)
        self.actionSave.setObjectName("actionSave")
        self.actionPrev_image = QtGui.QAction(parent=MainWindow)
        self.actionPrev_image.setCheckable(False)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon/icons/上一步_back.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionPrev_image.setIcon(icon9)
        self.actionPrev_image.setMenuRole(QtGui.QAction.MenuRole.TextHeuristicRole)
        self.actionPrev_image.setPriority(QtGui.QAction.Priority.NormalPriority)
        self.actionPrev_image.setObjectName("actionPrev_image")
        self.actionNext_image = QtGui.QAction(parent=MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icon/icons/下一步_next.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionNext_image.setIcon(icon10)
        self.actionNext_image.setObjectName("actionNext_image")
        self.actionShortcut = QtGui.QAction(parent=MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icon/icons/键盘_keyboard-one.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionShortcut.setIcon(icon11)
        self.actionShortcut.setObjectName("actionShortcut")
        self.actionAbout = QtGui.QAction(parent=MainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icon/icons/ISAT13.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionAbout.setIcon(icon12)
        self.actionAbout.setObjectName("actionAbout")
        self.actionSegment_anything_point = QtGui.QAction(parent=MainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icon/icons/M_Favicon.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icon/icons/删除_delete.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionDelete.setIcon(icon14)
        self.actionDelete.setObjectName("actionDelete")
        self.actionBit_map = QtGui.QAction(parent=MainWindow)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icon/icons/编辑_edit.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionEdit.setIcon(icon15)
        self.actionEdit.setObjectName("actionEdit")
        self.actionTo_top = QtGui.QAction(parent=MainWindow)
        self.actionTo_top.setEnabled(False)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icon/icons/去顶部_to-top.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionTo_top.setIcon(icon16)
        self.actionTo_top.setObjectName("actionTo_top")
        self.actionTo_bottom = QtGui.QAction(parent=MainWindow)
        self.actionTo_bottom.setEnabled(False)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icon/icons/去底部_to-bottom.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionTo_bottom.setIcon(icon17)
        self.actionTo_bottom.setObjectName("actionTo_bottom")
        self.actionBackspace = QtGui.QAction(parent=MainWindow)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icon/icons/删除_delete-two.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icon/icons/关闭_close-one.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionCancel.setIcon(icon19)
        self.actionCancel.setObjectName("actionCancel")
        self.actionFinish = QtGui.QAction(parent=MainWindow)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/icon/icons/校验_check-one.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/icon/icons/锚点_anchor.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionPolygon.setIcon(icon21)
        self.actionPolygon.setObjectName("actionPolygon")
        self.actionVisible = QtGui.QAction(parent=MainWindow)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/icon/icons/眼睛_eyes.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionVisible.setIcon(icon22)
        self.actionVisible.setObjectName("actionVisible")
        self.actionModel_manage = QtGui.QAction(parent=MainWindow)
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/icon/icons/列表_list-middle.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.actionConverter = QtGui.QAction(parent=MainWindow)
        icon24 = QtGui.QIcon()
        icon24.addPixmap(QtGui.QPixmap(":/icon/icons/转换文件夹1_folder-conversion-one.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionConverter.setIcon(icon24)
        self.actionConverter.setObjectName("actionConverter")
        self.actionAuto_segment_with_bounding_box = QtGui.QAction(parent=MainWindow)
        ...
        self.actionAnno_validator = QtGui.QAction(parent=MainWindow)
        icon25 = QtGui.QIcon()
        icon25.addPixmap(QtGui.QPixmap(":/icon/icons/检查_inspection.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon26 = QtGui.QIcon()
        icon26.addPixmap(QtGui.QPixmap(":/icon/icons/复制_copy.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionCopy.setIcon(icon26)
        self.actionCopy.setObjectName("actionCopy")
        self.actionUnion = QtGui.QAction(parent=MainWindow)
        icon27 = QtGui.QIcon()
        icon27.addPixmap(QtGui.QPixmap(":/icon/icons/合并选择_union-selection.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionUnion.setIcon(icon27)
        self.actionUnion.setObjectName("actionUnion")
        self.actionSubtract = QtGui.QAction(parent=MainWindow)
        icon28 = QtGui.QIcon()
        icon28.addPixmap(QtGui.QPixmap(":/icon/icons/减去上一层_subtract-selection-one.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionSubtract.setIcon(icon28)
        self.actionSubtract.setObjectName("actionSubtract")
        self.actionIntersect = QtGui.QAction(parent=MainWindow)
        icon29 = QtGui.QIcon()
        icon29.addPixmap(QtGui.QPixmap(":/icon/icons/相交选择_intersect-selection.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionIntersect.setIcon(icon29)
        self.actionIntersect.setObjectName("actionIntersect")
        self.actionExclude = QtGui.QAction(parent=MainWindow)
        icon30 = QtGui.QIcon()
        icon30.addPixmap(QtGui.QPixmap(":/icon/icons/排除选择_exclude-selection.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionExclude.setIcon(icon30)
        self.actionExclude.setObjectName("actionExclude")
        self.actionVideo_segment = QtGui.QAction(parent=MainWindow)
        icon31 = QtGui.QIcon()
        icon31.addPixmap(QtGui.QPixmap(":/icon/icons/play-all.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionVideo_segment.setIcon(icon31)
        self.actionVideo_segment.setObjectName("actionVideo_segment")
        self.actionVideo_segment_once = QtGui.QAction(parent=MainWindow)
        icon32 = QtGui.QIcon()
        icon32.addPixmap(QtGui.QPixmap(":/icon/icons/play-1.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionVideo_segment_once.setIcon(icon32)
        self.actionVideo_segment_once.setObjectName("actionVideo_segment_once")
        self.actionVideo_segment_five_times = QtGui.QAction(parent=MainWindow)
        icon33 = QtGui.QIcon()
        icon33.addPixmap(QtGui.QPixmap(":/icon/icons/play-5.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.actionVideo_to_frames = QtGui.QAction(parent=MainWindow)
        icon34 = QtGui.QIcon()
        icon34.addPixmap(QtGui.QPixmap(":/icon/icons/视频_video-two.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionVideo_to_frames.setIcon(icon34)
        self.actionVideo_to_frames.setObjectName("actionVideo_to_frames")
        self.actionSegment_anything_box = QtGui.QAction(parent=MainWindow)
        icon35 = QtGui.QIcon()
        icon35.addPixmap(QtGui.QPixmap(":/icon/icons/小矩形_rectangle-small.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionSegment_anything_box.setIcon(icon35)
        self.actionSegment_anything_box.setObjectName("actionSegment_anything_box")
        self.actionPrev_group = QtGui.QAction(parent=MainWindow)
        self.actionPrev_group.setIcon(icon9)
        self.actionPrev_group.setObjectName("actionPrev_group")
        self.actionNext_group = QtGui.QAction(parent=MainWindow)
        self.actionNext_group.setIcon(icon10)
        self.actionNext_group.setObjectName("actionNext_group")
        self.actionRepaint = QtGui.QAction(parent=MainWindow)
        icon36 = QtGui.QIcon()
        icon36.addPixmap(QtGui.QPixmap(":/icon/icons/编辑撰写_writing-fluently.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionRepaint.setIcon(icon36)
        self.actionRepaint.setObjectName("actionRepaint")
        self.actionScene_shot = QtGui.QAction(parent=MainWindow)
        icon37 = QtGui.QIcon()
        icon37.addPixmap(QtGui.QPixmap(":/icon/icons/截屏_screenshot-two.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionScene_shot.setIcon(icon37)
        self.actionScene_shot.setObjectName("actionScene_shot")
        self.actionWindow_shot = QtGui.QAction(parent=MainWindow)
        ...
        icon38 = QtGui.QIcon()
        icon38.addPixmap(QtGui.QPixmap(":/icon/icons/中文_chinese.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
