# Form implementation generated from reading ui file 'ISAT/ui\auto_segment.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_image_dir = QtWidgets.QLineEdit(parent=self.widget)
        self.lineEdit_image_dir.setObjectName("lineEdit_image_dir")
        self.horizontalLayout.addWidget(self.lineEdit_image_dir)
        self.pushButton_image_dir = QtWidgets.QPushButton(parent=self.widget)
        ...
        self.lineEdit_label_dir = QtWidgets.QLineEdit(parent=self.widget_2)
        self.lineEdit_label_dir.setObjectName("lineEdit_label_dir")
        self.horizontalLayout_2.addWidget(self.lineEdit_label_dir)
        self.pushButton_label_dir = QtWidgets.QPushButton(parent=self.widget_2)
        ...
        self.lineEdit_save_dir = QtWidgets.QLineEdit(parent=self.widget_3)
        self.lineEdit_save_dir.setObjectName("lineEdit_save_dir")
        self.horizontalLayout_3.addWidget(self.lineEdit_save_dir)
        self.pushButton_save_dir = QtWidgets.QPushButton(parent=self.widget_3)
        ...
        spacerItem = QtWidgets.QSpacerItem(461, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_4.addItem(spacerItem)
        self.pushButton_start = QtWidgets.QPushButton(parent=self.widget_4)
        self.pushButton_start.setObjectName("pushButton_start")
        self.horizontalLayout_4.addWidget(self.pushButton_start)
        self.pushButton_cancel = QtWidgets.QPushButton(parent=self.widget_4)
