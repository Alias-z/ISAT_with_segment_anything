# Form implementation generated from reading ui file 'ISAT/ui\category_dock.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_search_category = QtWidgets.QLineEdit(parent=Form)
        self.lineEdit_search_category.setFocusPolicy(QtCore.Qt.FocusPolicy.ClickFocus)
        ...
        self.pushButton_category_setting = QtWidgets.QPushButton(parent=Form)
        ...
        self.pushButton_group_mode = QtWidgets.QPushButton(parent=Form)
        ...
        self.pushButton_decrease = QtWidgets.QPushButton(parent=Form)
        ...
        self.lineEdit_currentGroup = QtWidgets.QLineEdit(parent=Form)
        self.lineEdit_currentGroup.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.lineEdit_currentGroup.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.lineEdit_currentGroup.setText("")
        self.lineEdit_currentGroup.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight | QtCore.Qt.AlignmentFlag.AlignTrailing | QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.lineEdit_currentGroup.setObjectName("lineEdit_currentGroup")
        self.horizontalLayout.addWidget(self.lineEdit_currentGroup)
        self.pushButton_increase = QtWidgets.QPushButton(parent=Form)
