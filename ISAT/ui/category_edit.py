# Form implementation generated from reading ui file 'ISAT/ui\category_edit.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_category = QtWidgets.QLineEdit(parent=self.widget_3)
        self.lineEdit_category.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight | QtCore.Qt.AlignmentFlag.AlignTrailing | QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.spinBox_group = QtWidgets.QSpinBox(parent=self.widget_3)
        ...
        self.lineEdit_note = QtWidgets.QLineEdit(parent=self.widget_5)
        self.lineEdit_note.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight | QtCore.Qt.AlignmentFlag.AlignTrailing | QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.label_layer = QtWidgets.QLabel(parent=self.widget_5)
        ...
        self.label_layer.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight | QtCore.Qt.AlignmentFlag.AlignTrailing | QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.checkBox_iscrowded = QtWidgets.QCheckBox(parent=self.widget_2)
        self.checkBox_iscrowded.setObjectName("checkBox_iscrowded")
        self.horizontalLayout_2.addWidget(self.checkBox_iscrowded)
        spacerItem = QtWidgets.QSpacerItem(97, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem)
        self.pushButton_cancel = QtWidgets.QPushButton(parent=self.widget_2)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/关闭_close-one.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButton_cancel.setIcon(icon)
        self.pushButton_cancel.setObjectName("pushButton_cancel")
        self.horizontalLayout_2.addWidget(self.pushButton_cancel)
        self.pushButton_apply = QtWidgets.QPushButton(parent=self.widget_2)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/校验_check-one.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
