# Form implementation generated from reading ui file 'ISAT/ui\file_dock.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.widget_state = QtWidgets.QWidget(parent=Form)
        ...
        self.label_prev_state = QtWidgets.QLabel(parent=self.widget_state)
        ...
        self.label_current_state = QtWidgets.QLabel(parent=self.widget_state)
        ...
        self.label_next_state = QtWidgets.QLabel(parent=self.widget_state)
        ...
        self.label = QtWidgets.QLabel(parent=self.widget_num)
        self.label.setObjectName("label")
        self.horizontalLayout.addWidget(self.label)
        self.label_all = QtWidgets.QLabel(parent=self.widget_num)
